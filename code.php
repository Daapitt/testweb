...
{
    $id_siswa = mysqli_real_escape_string($con, $_POST['id']);
    $nama = mysqli_real_escape_string($con, $_POST['nama']);
    $email = mysqli_real_escape_string($con, $_POST['email']);
    $no_hp = mysqli_real_escape_string($con, $_POST['no_hp']);
    $jurusan = mysqli_real_escape_string($con, $_POST['jurusan']);

    $query = "UPDATE siswa SET nama='$nama', email='$email', no_hp='$no_hp', jurusan='$jurusan', alamat='$alamat', tanggal_lahir='$tanggal_lahir' WHERE id='$id_siswa'";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['simpan']))
{
    ...
    $no_hp = mysqli_real_escape_string($con, $_POST['no_hp']);
    $jurusan = mysqli_real_escape_string($con, $_POST['jurusan']);
    $query = "INSERT INTO siswa (nama,email,no_hp,jurusan,alamat,jurusan) VALUES
    ('$id','$nama','$email','$no_hp','$jurusan')";
